...
//HOISTING 
console.log(a); // undefined (a variable is hoisted and undefined is assigned to it)
var a = 10;

console.log(b, c); // ReferenceError (b and c are hoisted(in TEMPORAL DEAD ZONE) but not initialized)
const b = 3;
let c = 5;
